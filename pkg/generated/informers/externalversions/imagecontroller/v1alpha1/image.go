	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ImagecontrollerV1alpha1().Images(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ImagecontrollerV1alpha1().Images(namespace).Watch(context.TODO(), options)
			},
		},
		&imagecontrollerv1alpha1.Image{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&imagecontrollerv1alpha1.Image{}, f.defaultInformer)
}
